...
%%
Folder = '/Users/justinschaffner/Desktop/GitRepositories/stretch-sense/Data/SenseAppData/';
...
capfiles = ["CAP_2018-03-07542161920_U_F_CENTER.csv","CAP_2018-03-07542162176_U_R_CORNER.csv"];
GTfiles = ["GT_2018-03-07542161920_U_F_CENTER.csv","GT_2018-03-07542162176_U_R_CORNER.csv"];
figure; hold on;
...
legend('front-center', 'right-corner');
