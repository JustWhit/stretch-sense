...
Folder = 'Y:\Justin\GitRepositories\stretch-sense\Data';
...
VOLFiles = {'SVCVOLTest11T1_08_08_18.csv' 'SVCVOLTest11T2_08_08_18.csv' 'SVCVOLTest11T3_08_08_18.csv' 'SVCVOLTest11T4_08_08_18.csv'};
FLOWFiles = {'SVCFLOWTest11T1_08_08_18.csv' 'SVCFLOWTest11T2_08_08_18.csv' 'SVCFLOWTest11T3_08_08_18.csv' 'SVCFLOWTest11T4_08_08_18.csv'};
capFile=char(fullfile(Folder,dFolder,'\Xiphoid\CAP_HEART_SPIRO\CAP_2018-08-08_Test11_Justin_SVC.csv'));
noteFile = char(fullfile(Folder,dFolder,'\Xiphoid\CAP_HEART_SPIRO\GT_2018-08-08_Test11_Justin_SVC.csv'));
...
function a = extract(VOLTraces, FLOWTraces, WSensorTS, NoteTime, Sample)
    ...
    timevector = SensorTS.Time;
    VOLTS = resample(VOLTS,timevector);
    FLOWTS = resample(FLOWTS,timevector);
...
%     
    ...
    Sensors.Time = setTimeStamps(Sensors.Time);
    Sensors = getsampleusingtime(Sensors,Sensors.Time(1),SpiroTS.Time(end));
