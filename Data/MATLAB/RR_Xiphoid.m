...
figure, hold on, plot(test,'o'), plot(pred,'o'),plot(actual,'o'), title('Capacitance with Predicterd and Actual Volume'), legend(['Capacitance(pF)';'Pvolume(L)     ';'Avolume(L)     ']),xlabel('Data'), ylabel('Value');
